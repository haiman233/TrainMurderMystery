...
public class TMMBlockTagGen extends FabricTagProvider.BlockTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        this.tag(TMMBlockTags.BRANCHES)
