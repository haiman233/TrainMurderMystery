...
public class TrimmedStairsBlock extends HorizontalFacingBlock {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        BlockState leftState = Level.getBlockState(pos.offset(facing.rotateYClockwise()));
        BlockState rightState = Level.getBlockState(pos.offset(facing.rotateYCounterclockwise()));
