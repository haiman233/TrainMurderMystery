...
public class BarBlock extends PillarBlock {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        return this.getDefaultState().with(AXIS, ctx.getSide().getAxis())
                .with(TOP, !this.isConnectedBar(Level.getBlockState(pos.offset(topDirection)), axis))
                .with(BOTTOM, !this.isConnectedBar(Level.getBlockState(pos.offset(topDirection.getOpposite())), axis));
    }
