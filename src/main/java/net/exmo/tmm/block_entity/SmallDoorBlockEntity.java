...
public class SmallDoorBlockEntity extends DoorBlockEntity {
    ...
    protected void toggleBlocks() {
        ...
        this.Level.setBlockState(this.pos, this.getCachedState().with(SmallDoorBlock.OPEN, this.open), Block.NOTIFY_LISTENERS | Block.FORCE_STATE);
        this.Level.setBlockState(this.pos.up(), this.getCachedState().with(SmallDoorBlock.OPEN, this.open).with(SmallDoorBlock.HALF, DoubleBlockHalf.UPPER), Block.NOTIFY_LISTENERS | Block.FORCE_STATE);
    }
